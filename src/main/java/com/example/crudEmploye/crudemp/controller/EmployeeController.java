package com.example.crudEmploye.crudemp.controller;
...
import com.example.crudEmploye.crudemp.service.EmployeeService;
...
public class EmployeeController {
	...
	public String showFormForUpdate(@PathVariable(value="id") long id, Model model) {
		...
		//set emp as a model attribute to prepopulate the form
		model.addAttribute("employee", employee);
